                                ...
                                <div class="input-states">
                                   ...
                                   <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="stud_id" value="<?php echo $stud_id; ?>" class="form-control" placeholder="Register No" id="event" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"  name="slname" id="lname" class="form-control" id="event" placeholder="Last Name" value="<?php echo $slname; ?>" required="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="scontact" class="form-control" placeholder="Contact No" id="tbNumbers" minlength="10" maxlength="10" onkeypress="javascript:return isNumber(event)" required="" value="<?php echo $scontact; ?>">
                                                </div>
                                            </div>
                                        </div>
