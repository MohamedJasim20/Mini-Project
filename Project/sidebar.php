                ...
                <nav class="sidebar-nav">
                    ...
                    <?php } } ?>
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">STAFF MANAGEMENT</span></a>
                            ...
                            <?php if(isset($useroles)){  if(in_array("add_teacher",$useroles)){ ?> 
                                <li><a href="add_teacher.php">Add staff</a></li>
                            <?php } } ?>
                                <li><a href="view_teacher.php">View staff</a></li>
                            </ul>
                        </li>
                    <?php } } ?> 
                  ...
                  <?php if(isset($useroles)){  if(in_array("manage_user",$useroles)){ ?> 
                    ...
                    <?php if($_SESSION["username"]=='admin') { ?>
                         <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-lock"></i><span class="hide-menu">USER PERMISSION</span></a>
                            <ul aria-expanded="false" class="collapse">
                         ...
                         <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-cog"></i><span class="hide-menu">SETTINGS</span></a>
                            <ul aria-expanded="false" class="collapse">
                               <li><a href="manage_website.php">Appearance Settings</a></li>
                              <li><a href="email_config.php">Email Settings</a></li>
                            </ul>
                        </li> 
