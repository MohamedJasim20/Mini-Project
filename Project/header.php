    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
             ...
             ?>
                        <b><img src="uploadImage/Logo/<?php echo $row_header_logo['logo'];?>" alt="HOMEPAGE" class="dark-logo" style="width:75%;height:75%;"/></b>
                    </a>
                </div>
                                ...
                                while($row=mysqli_fetch_array($query))
                                    {
                                      ...
                                      $image = $row['image'];
                                                                    ...
                                                                    ?>
                                <img src="uploadImage/profile/admin.png<?=$image?>" alt="user" class="profile-pic" /></a>
