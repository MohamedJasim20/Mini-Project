                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form">
                                <center><img src="uploadImage/Logo/download.png" style="width:50%;"></center><br>
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" class="form-control" value="" id="myInput" placeholder="Password" required=""><br>
