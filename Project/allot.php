...
include('../connect.php');
extract($_POST);
   $sql = "INSERT INTO `allot` (`class_id`,`room_type_id`,`subject_id`,`exam_id`,`added_date`,allot_rid,allot_tid) VALUES ('$class_id','$room_type_id','$subject_id','$exam_id','".date('Y-m-d')."','$room_id','$teacher_id')";
